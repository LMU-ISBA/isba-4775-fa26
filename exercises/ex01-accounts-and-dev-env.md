...
| [Claude Pro](https://claude.ai/login?plan=pro)                     | Subscribe at full price, because there's no student rate. [OpenAI's Codex](https://openai.com/codex/), on a ChatGPT subscription, is an accepted alternative. You need one of the two for the interview below and for Exercise 03 |
